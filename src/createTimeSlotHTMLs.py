...
def createIndexFiles(jsonFilename,outputDir,indexFilenameListFilename,verbose=False):
	import shutil;
	import os;
...
def createHTMLs(jsonFilename,outputDir,indexFilenameListFilename,indexFileDir,verbose=False):
	import cPickle;
	import jsonHelper;
